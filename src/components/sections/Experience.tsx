    ...
    <section id="experience" className="relative border-t border-border py-28 sm:py-36">
      <div className="mx-auto max-w-7xl px-6 sm:px-10">
        ...
        <div className="relative mt-16">
          <div className="absolute left-[7px] top-2 hidden h-[calc(100%-2rem)] w-px bg-border sm:block" />
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 border-t border-border pt-10 sm:grid-cols-2">
          {education.map((entry) => (
            <div key={entry.degree} className="flex items-start gap-4">
              <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-border bg-surface text-accent-2">
              ...
              <div>
                ...
                <p className="mt-1 font-mono text-[11px] uppercase tracking-[0.15em] text-muted-2">
