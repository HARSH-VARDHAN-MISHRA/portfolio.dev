...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Naxodent",
    period: "2025",
    category: "Shopify D2C Storefront",
    description:
      "A dental-care D2C storefront on Shopify — clinically-positioned product pages, a streamlined checkout, and a catalog structure built to convert browsers into buyers rather than just list products.",
